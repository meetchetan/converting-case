...
const TermsandConditions = () => {
  return (
    <div>
      <h1>Terms and Conditions for ConvertingCase</h1>

      <h2>Introduction</h2>

      <p>
        These Website Standard Terms and Conditions written on this webpage
        shall manage your use of our website, ConvertingCase accessible at
        https://convertingcase.com/.
      </p>
      ...
      <p>
        ...
        disagree with any of these Website Standard Terms and Conditions. These
        Terms and Conditions have been generated with the help of the{" "}
      ...
      <p>
        Other than the content you own, under these Terms, ConvertingCase and/or
      ...
      <p>
        ...
        and ConvertingCase may further restrict access by you to any areas of
      ...
      <p>
        ...
        ConvertingCase a non-exclusive, worldwide irrevocable, sub licensable
      ...
      <p>
        ...
        rights. ConvertingCase reserves the right to remove any of Your Content
      ...
      <p>
        This Website is provided "as is," with all faults, and ConvertingCase
      ...
      <p>
        In no event shall ConvertingCase, nor any of its officers, directors and
        ...
        under contract.  ConvertingCase, including its officers, directors and
      ...
      <p>
        You hereby indemnify to the fullest extent ConvertingCase from and
      ...
      <p>
        ConvertingCase is permitted to revise these Terms at any time as it sees
      ...
      <p>
        The ConvertingCase is allowed to assign, transfer, and subcontract its
      ...
      <p>
        These Terms constitute the entire agreement between ConvertingCase and
